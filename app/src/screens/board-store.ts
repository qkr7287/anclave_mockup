...
[ 사용자 협조 사항 ]
장기 미사용 자원은 미리 자율 반납해 주시면 신규 프로젝트 배정이 원활해집니다. 반납은 '자원 신청현황 > 변경·회수'에서 신청하실 수 있습니다.
...
const QNAS: BoardPost[] = [
  ...
  },
  {
    ...
    answer: { byUserId: 'u-admin', at: '2026-06-13 11:15', body: '자원 신청현황 > 상세 보기에서 "변경 · 회수" 신청으로 진행하시면 됩니다. 회수 신청 후 관리자 승인 시 반영됩니다.' },
  },
  {
